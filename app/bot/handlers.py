...
QF — Тихие ноги (точная постановка без переставления)
HP — Положение таза (близко к стене = ноги работают)
DM — Противовес (координация противоположных конечностей)
RR — Считывание (планирование маршрута перед лазанием)
RT — Ритм (равномерность темпа движений)
DC — Контроль динамики (точность бросков и стабилизация)
GR — Мягкость перехватов (плавное отпускание зацепов)

Кружочки = напряжение (зелёный<30%, жёлтый<60%, оранжевый<80%, красный>80%)
Внизу слева: Стабильность, Продуктивность, Экономичность, Баланс"""
